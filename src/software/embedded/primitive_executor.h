...
class PrimitiveExecutor
{
   ...
   private:
    ...
    // enough that we switch to following the new trajectory. Set to 0 (always switch to
    // the newly received trajectory) to match the known-good tuning baseline.
    static constexpr double LINEAR_HAUSDORFF_THRESHOLD_M = 0.0;
